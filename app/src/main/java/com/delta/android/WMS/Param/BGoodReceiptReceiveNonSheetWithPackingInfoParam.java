...
public class BGoodReceiptReceiveNonSheetWithPackingInfoParam extends BStockBaseParam {

    public static final String GrMasterObj = "Unicom.Uniworks.BModule.WMS.INV.Parameter.BGoodReceiptReceiveNonSheetWithPackingInfoParam.GrMasterObj"; //BGoodReceiptReceiveEditParam.GrMasterObj

    public static final String StorageInTempBin = "Unicom.Uniworks.BModule.WMS.INV.Parameter.BGoodReceiptReceiveNonSheetWithPackingInfoParam.StorageInTempBin";
//

    public class GrNonSheetWithPackingInfoMasterObj{
        ...
        private ArrayList<GrNonSheetWithPackingInfoDetObj> GrDetails;

        public ArrayList<GrNonSheetWithPackingInfoDetObj> GrDetails() {return GrDetails;}
        public void setGrDetails(ArrayList<GrNonSheetWithPackingInfoDetObj> grDetails){ GrDetails = grDetails; }

        public GrNonSheetWithPackingInfoMasterObj()
        {
        }

        public final GrNonSheetWithPackingInfoMasterObj GetGrrSheet(DataTable dtMst, DataTable dtDet, DataTable dtSn){

            GrNonSheetWithPackingInfoMasterObj mst = new GrNonSheetWithPackingInfoMasterObj();
            GrNonSheetWithPackingInfoDetObj det = null;
            ...
            int seq = 0;
            ArrayList<GrNonSheetWithPackingInfoDetObj> detList = new ArrayList<>();
            for (DataRow dr: dtDet.Rows){
                seq++;
                det = new GrNonSheetWithPackingInfoDetObj();

                det.setPOSeq("0"+dr.getValue("PO_SEQ").toString());
                det.setPONO(dr.getValue("PO_NO").toString());
                ...
                if (dtSn != null && dr.getValue("GRR_DET_SN_REF_KEY") != null){
                    ArrayList<GrrWithPackingInfoSnObj> lstSn = new ArrayList<>();
    ...
    public class GrNonSheetWithPackingInfoDetObj{
        ...
        public ArrayList<GrrWithPackingInfoSnObj> getGrSns(){return GrSns;}
