...
public class SheetDetGridAdapter extends BaseAdapter {
    ...
    public SheetDetGridAdapter(DataTable sheetData, LayoutInflater inflater, DataTable pickData, boolean isPick, Context context) {
    ...
    public SheetDetGridAdapter(DataTable sheetData, LayoutInflater inflater, DataTable pickData, DataTable rsvData, boolean isPick, Context context) {
        this.SheetData = sheetData;
        this.PickData = pickData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = this.Inflater.inflate(R.layout.activity_wms_good_pick_detail_listview, null);
        ...
        String strArgb = SheetData.Rows.get(position).getValue("ARGB_LIGHT_COLOR").toString();
        ...
        for (DataRow drPick : PickData.Rows) {
            if (SheetData.Rows.get(position).getValue("SHEET_MST_KEY").equals(drPick.getValue("SHEET_MST_KEY"))
                ...
                if (drPick.getValue("PICK_STATUS").equals("Picking")) { // Picked
