...
public class GoodCancelPickActivity extends BaseFlowActivity {
    //WAPG028
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_cancel_pick);
        ...
        CallBIModule(bmObj, new WebAPIClientEvent() {
            ...
            public void onPostBack(BModuleReturn bModuleReturn) {
                if (CheckBModuleReturnInfo(bModuleReturn)) {
                    ...
                    ArrayAdapter<String> adapterSheetType = new ArrayAdapter<>(GoodCancelPickActivity.this, android.R.layout.simple_spinner_dropdown_item, sheetTypes);
...
//        }
    ...
    public void ClickConfirm(View v) {
        ...
        for (DataRow drCheck : resultTable.Rows) {
            if (!(drCheck.getValue("PICK_STATUS").toString().equals("Picking") ||
                    drCheck.getValue("PICK_STATUS").toString().equals("Picked")) ) {

                Object[] args = new Object[2];
                args[0] = drCheck.getValue("PICK_STATUS").toString();
                args[1] = "Picking, Picked";
                ShowMessage(R.string.WAPG028003, args); // WAPG028003 揀料狀態為[%s]須為[%s]才能進行取消揀料作業
                return;
            }
        }
        ...
        gotoNextActivity(GoodCancelPickDetailActivity.class, sheetData);
    }
    ...
    public void OnClickQRScan(View v) {
        IntentIntegrator integrator = new IntentIntegrator(GoodCancelPickActivity.this);
        ...
        CallBIModule(lstBmObj, new WebAPIClientEvent() {
            ...
            public void onPostBack(BModuleReturn bModuleReturn) {
                if (CheckBModuleReturnInfo(bModuleReturn)) {
                    ...
                    if (((DataColumnCollection) dtMst.getColumns()).get("SOURCE_SHEET_ID") == null) //!dtMst.getColumns().contains("SOURCE_SHEET_ID")
                    {
                        DataColumn dcSource = new DataColumn("SOURCE_SHEET_ID");
                        dtMst.addColumn(dcSource);
