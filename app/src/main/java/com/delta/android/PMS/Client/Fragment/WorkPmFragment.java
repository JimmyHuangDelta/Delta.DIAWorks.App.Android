...
public class WorkPmFragment extends Fragment {
    ...
    public static WorkPmFragment newInstance(String pageTitle, String woId, String eqpId) {
        WorkPmFragment fragment = new WorkPmFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final WorkPmActivity activity = (WorkPmActivity) getActivity();
                ...
                lsSop.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        if (!activity.GetIsWork()) {
                            ((WorkPmActivity) getActivity()).ShowMessage(getResources().getString(R.string.EAPE105020));
                            return;
                        }
                        ...
                        if (!checkPermission.CheckPermission(arReqPermission)) { //檢核是否有缺少開通的權限
                            ...
                            while (cursor.moveToNext()) {
                                ...
                                msg += curFileName;
                                if (cursor.getPosition() != cursor.getCount() - 1) msg += "\n";
                            }
                            //取選擇項目副檔名
                                            ...
                                            .setPositiveButton(getResources().getString(R.string.CONFIRM), new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    if (networkInfo == null || !networkInfo.isConnected()) {
                                                        ShowMessage(R.string.EAPE105003);
                                                    } else {
                                                        //註銷BroadcastReceiver
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.CONFIRM), new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (csLatest.getCount() <= 0) {
                                                ((WorkPmActivity) getActivity()).ShowMessage(getResources().getString(R.string.EAPE105023));
                                                return;
                                            }
...
/*                lsUserWh.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                        ...
                        btnConfirm.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (strUserId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105004), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (edUserStartDate.getText().toString().contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105005), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (edUserStartTime.getText().toString().contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105006), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (edUserEndDate.getText().toString().contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105007), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (edUserEndTime.getText().toString().contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105008), Toast.LENGTH_LONG).show();
                                    return;
                                }
                                ...
                                if (comResult >= 0) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105009), Toast.LENGTH_LONG).show();
            ...
            case "CHECK_ITEM":
                ...
                CheckItemAdapter checkItemAdapter = new CheckItemAdapter(getActivity(), layoutInflater, CursorCheckItem, woId);
                lsCheckItem.setAdapter(checkItemAdapter);
                        ...
                        btnConfirm.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (edTrxQty.getText().toString().contentEquals("") ||
                                        trxQty <= 0) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105010), Toast.LENGTH_LONG).show();
                                    return;
                                }
                                ...
                                if (Integer.parseInt(edPartQty.getText().toString()) < Integer.parseInt(edTrxQty.getText().toString())) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105011), Toast.LENGTH_LONG).show();
                                    return;
                                } else {
                                ...
                                if (strStorageId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105012), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (strBinId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105013), Toast.LENGTH_LONG).show();
                                    return;
                                }
                        ...
                        btnConfirm.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (strPartId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105014), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (edPartLot.getText().toString().contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105015), Toast.LENGTH_LONG).show();
                                    return;
                                }
                                ...
                                if (edPartQty.getText().toString().contentEquals("") ||
                                        trxQty <= 0) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105016), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (strStorageId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105017), Toast.LENGTH_LONG).show();
                                    return;
                                }

                                if (strBinId[0].contentEquals("")) {
                                    Toast.makeText(getContext(), getResources().getString(R.string.EAPE105018), Toast.LENGTH_LONG).show();
                                    return;
                                }
                                ...
                                csInv.moveToFirst();
                                if (csInv.getCount() <= 0) {
                                    ((WorkPmActivity) getActivity()).ShowMessage(getResources().getString(R.string.EAPE105024));
                                    return;
                                }

                                if (csInv.getInt(csInv.getColumnIndex("QTY")) < Integer.parseInt(edPartQty.getText().toString())) {
                                    ((WorkPmActivity) getActivity()).ShowMessage(getResources().getString(R.string.EAPE105025));
                                    return;
                                }
                            ...
                            btnConfirm.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (edFileName.getText().toString().contentEquals("")) {
                                        Toast.makeText(getContext(), getResources().getString(R.string.EAPE105019), Toast.LENGTH_LONG).show();
                                        return;
                                    }
    ...
    private void BindUserWh(ListView lsUserWh) {
        ...
        boolean isWork = ((WorkPmActivity) getActivity()).GetIsWork();
    ...
    public String getResString(String str) {
        int i = getResources().getIdentifier(str, "string", getActivity().getPackageName());
        if (i == 0) {
            return str;
        }
